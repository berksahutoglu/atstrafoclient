      ...
      cartItems.forEach((cartItem, index) => {
        if (
          ...
          fileUploadPromises.push(
            attachmentAPI.uploadFiles(requestId, formData)
          );
        }
      });
              ...
              <div className="mb-4">
                ...
                <div className="d-flex">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const files =
                        document.getElementById("requestFileUpload").files;
                      if (files.length > 0) {
                        const formData = new FormData();
                        ...
                        attachmentAPI
                          .uploadFiles(selectedRequestId, formData)
                          .then(() => {
                            ...
                            const fileInput =
                              document.getElementById("requestFileUpload");
                            if (fileInput) fileInput.value = "";
                          })
                          .catch((err) => {
                            setError(
